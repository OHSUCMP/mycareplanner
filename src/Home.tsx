            ...
            <div className="home-view">
                ...
                <div className="welcome">
                    {
                        ...
                        <>
                            ...
                            {(toupp) ?
                                <a style={{textAlign: 'center'}} href={toupp} target="_blank" rel="noopener noreferrer">Terms
                                    of Use and Privacy Policy</a> : ''}
                            <p>My Care Planner is a tool to help you and your care team work together to keep you
                                healthy. It is a completely personalized way to see what steps you’ve already taken and
                                what else you can do to check for and prevent illnesses.</p>
                        </>
                    }
                    {!fhirDataCollection || (fhirDataCollection && (fhirDataCollection[0]?.caregiverName === undefined)) ? '' :
                        <p className="subheadline">Caregiver <b>{fhirDataCollection && fhirDataCollection[0]?.caregiverName}</b>
                        </p>
                    }
                    {(!patients) ? '' :
                                                        ...
                                                        fhirDataAtIndex && (
                                                            isSDS
                                                                ? (
                                                                    ...
                                                                    <>
                                                                        <b>SDS
                                                                            for {curPatient?.fullName}</b> {fhirDataAtIndex.serverName}
                                                                    </>
                                                                )
                                                                : (
                                                                    <>
                ...
                : <ul>
                    ...
                    <li key={idx.toString()}><Link to={{
                        ...
                        <div>
                            ...
                            <div>
                                ...
                                <Link to={{
                                    ...
                                    state: {fhirDataCollection: this.props.fhirDataCollection}
                                }}>Login to additional healthcare provider accounts</Link>
                            </div>
                        ...
                        <p>This application is provided for informational purposes only and does not constitute medical
                            advice or professional services. The information provided should not be used for diagnosing
                            or treating a health problem or disease, and those seeking personal medical advice should
                            consult with a licensed physician. Always seek the advice of your doctor or other qualified
                            health provider regarding a medical condition. Never disregard professional medical advice
                            or delay in seeking it because of something you have read in this application. If you think
